      ...
      <main className="flex-1">
        <div className="max-w-3xl mx-auto px-4 py-10">
          ...
          <TableOfContents items={[
            { id: "why-confusing", label: "電動鼻吸い器、なぜ迷いやすいのか" },
            { id: "selection-axes", label: "選ぶときに見るべき5つの軸" },
            { id: "stationary-vs-handy", label: "据え置き型とハンディ型、どちらがいい？" },
          ...
          {/* 3. 据え置き vs ハンディ */}
          <section id="stationary-vs-handy" className="mb-8">
          ...
          <ShareButtons title="電動鼻吸い器の選びかた" path="/prepare/nasal-aspirator" />
